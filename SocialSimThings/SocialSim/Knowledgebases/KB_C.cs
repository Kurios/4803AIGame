...
namespace SocialSim
{
    ...
    class KB_C
    {
        ...
        {
            //Sad Topics
            Topic sadTopics = new Topic(TopicType.Sad, 0.25f, 0.8f, 0.25f);
            ...
            //Fun Topics
            Topic funTopics = new Topic(TopicType.Fun, 1.0f, -0.1f, 0.11f);
            ...
            //Friendly Topics
            Topic friendlyTopics = new Topic(TopicType.Friendly, 1.0f, 0.5f, 0.1f);
            ...
            //Scary Topics
            Topic scaryTopics = new Topic(TopicType.Scary, 0.11f, 0.3f, 0.85f);
